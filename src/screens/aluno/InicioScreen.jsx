...
function makeScreenStyles(t) {
  return {
    ...
    cumprimento: { fontSize: 14, fontWeight: '500', color: t.textSecondary, marginBottom: 4 },
    nome: { fontSize: 32, fontWeight: '800', color: t.textPrimary, letterSpacing: -0.5 },
    iconBadge: { width: 36, height: 36, borderRadius: 18, backgroundColor: t.surface, borderWidth: 1, borderColor: t.border, justifyContent: 'center', alignItems: 'center', marginTop: 6 },
